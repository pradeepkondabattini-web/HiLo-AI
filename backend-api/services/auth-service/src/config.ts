...
/**
 * Load auth-service configuration. Extends the shared base config with the Firebase
 * project id. All values come from the environment — never hardcoded (EOS-000 §25).
 */
export function loadAuthConfig(env: NodeJS.ProcessEnv = process.env): AuthServiceConfig {
